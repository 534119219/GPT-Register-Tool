        ...
        public static IReadOnlyList<SettingsCategoryDefinition> Categories { get; } = new[]
        {
            Category("邮箱与收信",
                ...
                Section("ReMail",
                    ...
                    Integer("remail_product_id", "产品ID", "email_registration.remail.product_id", "5"),
            ...
            Category("注册与接码",
                ...
                Section("阶段并发",
                    ...
                    Integer("registration_payment_concurrency", "支付并发", "registration.stage_concurrency.payment", "2")),
                Section("Sentinel",
            ...
            Category("网络与支付",
                ...
                Section("协议管理",
                    Multiline("protocol_proxy_pool", "协议支付代理池", ""),
                    Text("protocol_enabled_methods", "启用方式", "", "paypal,gopay,upi,ideal,pix,kakao,blik,twint,direct_card,momo"),
                ...
                Section("PayPal 与 GoPay",
                    ...
                    Text("protocol_gopay_service_addr", "GoPay服务地址", "gopay.payment_service_addr", "127.0.0.1:50051")),
                Section("地区支付代理",
                    ...
                    Text("protocol_direct_card_proxy", "直卡 Checkout", "protocol_payments.methods.direct_card.proxy"),
